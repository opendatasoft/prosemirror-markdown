...
var markdownitMark__default = /*#__PURE__*/_interopDefaultLegacy(markdownitMark);
...
var schema = new prosemirrorModel.Schema({
  ...
  marks: {
    ...
    mark: {
      parseDOM: [{tag: "mark"}],
      toDOM: function toDOM() { return ["mark"]}
    }
  }
});
...
var defaultMarkdownParser = new MarkdownParser(schema, markdownit__default['default']("commonmark", {html: false}).use(markdownitMark__default['default']), {
